...
const router = Router()
const { register, login, update, getEmployees } = require('../../controllers/models/user.controller')
...
router.get('/getEmployees', validateToken, policy, policy, getEmployees) // muestra todos los empleados de la empresa
